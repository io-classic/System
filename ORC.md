...
`  PROCEDURE Flush*;` [(source)](https://github.com/io-orig/System/blob/main/ORC.Mod#L11)


`  PROCEDURE Open*;` [(source)](https://github.com/io-orig/System/blob/main/ORC.Mod#L18)


`  PROCEDURE TestReq*;` [(source)](https://github.com/io-orig/System/blob/main/ORC.Mod#L28)


`  PROCEDURE SendInt(x: LONGINT);` [(source)](https://github.com/io-orig/System/blob/main/ORC.Mod#L34)


`  PROCEDURE Load*;  (*linked boot file  F.bin*)` [(source)](https://github.com/io-orig/System/blob/main/ORC.Mod#L42)


`  PROCEDURE Rec(VAR ch: CHAR);   (*receive with timeout*)` [(source)](https://github.com/io-orig/System/blob/main/ORC.Mod#L67)


`  PROCEDURE SendName(VAR s: ARRAY OF CHAR);` [(source)](https://github.com/io-orig/System/blob/main/ORC.Mod#L76)


`  PROCEDURE Send*;` [(source)](https://github.com/io-orig/System/blob/main/ORC.Mod#L83)


`  PROCEDURE Receive*;` [(source)](https://github.com/io-orig/System/blob/main/ORC.Mod#L118)


`  PROCEDURE Close*;` [(source)](https://github.com/io-orig/System/blob/main/ORC.Mod#L147)


`  PROCEDURE RecByte(VAR ch: CHAR);` [(source)](https://github.com/io-orig/System/blob/main/ORC.Mod#L154)


`  PROCEDURE RecInt(VAR x: LONGINT);` [(source)](https://github.com/io-orig/System/blob/main/ORC.Mod#L161)


`  PROCEDURE SR*;  (*send, then receive sequence of items*)` [(source)](https://github.com/io-orig/System/blob/main/ORC.Mod#L171)
