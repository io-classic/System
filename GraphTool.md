...
`  PROCEDURE DecGraph*;` [(source)](https://github.com/io-orig/System/blob/main/GraphTool.Mod#L7)


`  PROCEDURE DecGraph1*;` [(source)](https://github.com/io-orig/System/blob/main/GraphTool.Mod#L57)


`  PROCEDURE DecLibrary1*;` [(source)](https://github.com/io-orig/System/blob/main/GraphTool.Mod#L108)


`  PROCEDURE ConvertFontname(VAR x: ARRAY OF CHAR);` [(source)](https://github.com/io-orig/System/blob/main/GraphTool.Mod#L162)


`  PROCEDURE ConvertLibrary*;` [(source)](https://github.com/io-orig/System/blob/main/GraphTool.Mod#L169)
